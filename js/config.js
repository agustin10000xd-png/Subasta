...
const POSITIONS_433 = [
  { key: 'Arquero',                 label: 'Arquero',                 count: 1, pitchY: 88, pitchXs: [50] },
  { key: 'LateralDerecho',          label: 'Lateral Derecho',         count: 1, pitchY: 68, pitchXs: [85] },
  { key: 'CentralDerecho',          label: 'Central Derecho',         count: 1, pitchY: 68, pitchXs: [62] },
  { key: 'CentralIzquierdo',        label: 'Central Izquierdo',       count: 1, pitchY: 68, pitchXs: [38] },
  { key: 'LateralIzquierdo',        label: 'Lateral Izquierdo',       count: 1, pitchY: 68, pitchXs: [15] },
  { key: 'MediocampistaIzquierdo',  label: 'Mediocampista Izquierdo', count: 1, pitchY: 45, pitchXs: [20] },
  { key: 'MediocampistaC',          label: 'MediocampistaCentro',     count: 1, pitchY: 45, pitchXs: [50] },
  { key: 'MediocampistaD',          label: 'MediocampistaDerecho',    count: 1, pitchY: 45, pitchXs: [80] },
  ...
  { key: 'DelanteroC',              label: 'DelanteroCentro',         count: 1, pitchY: 18, pitchXs: [50] }
];
const BUDGET = 500;
const TIMER_SECS = 2;
